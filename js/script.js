...
(function ($) {
	...
	//Service Carousel
	if ($('.service-carousel-list').length) {
		$('.service-carousel-list').owlCarousel({
	...
	//Service Carousel
	if ($('.service-carousel-list2').length) {
		$('.service-carousel-list2').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 0,
			nav: false,
	...
	//Service Carousel
	if ($('.service-carousel-list3').length) {
		$('.service-carousel-list3').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 30,
			nav: false,
	...
	if ($('.tesimonail_list').length) {
		$('.tesimonail_list').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 0,
			nav: true,
	...
	if ($('.tesimonail_list-2').length) {
		$('.tesimonail_list-2').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 0,
			nav: true,
	...
	//Testimonial Carousel 2
	if ($('.tesimonail_list-3').length) {
		$('.tesimonail_list-3').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 25,
			nav: false,
	...
	//Testimonial Carousel 2
	if ($('.tesimonail_list-4').length) {
		$('.tesimonail_list-4').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 25,
			nav: false,
	...
	//Testimonial Carousel 2
	if ($('.tesimonail_list-5').length) {
		$('.tesimonail_list-5').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 25,
			nav: false,
	...
	if ($('.work-list2').length) {
		$('.work-list2').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 25,
			dot: false,
